  ...
  turkce: [
    {
      ...
      description: "Gerçek anlam, yan anlam, mecaz anlam, eş ve zıt anlamlı kelimeler, deyimler ve atasözleri konularını kapsar.",
      questionsCount: 1.0,
    },
    {
      title: "Cümlede Anlam",
      description: "Öznel-nesnel yargılar, neden-sonuç, amaç-sonuç, koşul cümleleri ve cümle yorumlama.",
      questionsCount: 2.0,
    },
    {
      title: "Paragraf Yapısı ve Anlamı",
      description: "Ana düşünce, yardımcı düşünceler, paragrafın yapısı (giriş, gelişme, sonuç) ve akışı bozan cümleler.",
      questionsCount: 17.0,
    },
    {
      title: "Anlatım Teknikleri",
      description: "Öyküleme, betimleme, açıklama, tartışma yöntemleri ve düşünceyi geliştirme yolları.",
      questionsCount: 1.0,
    },
    {
      title: "Ses Bilgisi",
      description: "Ünlü ve ünsüz düşmesi, türemesi, benzeşmesi, yumuşaması gibi dil bilgisi ses kuralları.",
      questionsCount: 1.0,
    },
    {
      title: "Sözcükte Yapı",
      description: "Kök, gövde, yapım ve çekim ekleri, basit, türemiş ve birleşik sözcük yapıları.",
      questionsCount: 0.5,
    },
    {
      title: "Sözcük Türleri (İsim, Sıfat, Zamir...)",
      description: "İsim, sıfat, zamir, zarf, edat, bağlaç, ünlem ve fiillerin özellikleri.",
      questionsCount: 0.5,
    },
    {
      title: "Fiilimsiler ve Fiilde Çatı",
      description: "İsim-fiil, sıfat-fiil, zarf-fiil özellikleri ve etken, edilgen, geçişli, geçişsiz fiil çatıları.",
      questionsCount: 0.5,
    },
    {
      title: "Cümlenin Ögeleri",
      description: "Özne, yüklem, nesne, dolaylı tümleç ve zarf tümleci bulma yöntemleri.",
      questionsCount: 0.5,
    },
    {
      title: "Cümle Türleri",
      description: "Yüklemin türü, yeri, anlamı ve yapısı (basit, birleşik, sıralı, bağlı) yönünden cümle çeşitleri; Karma Dil Bilgisi sorularında sıkça çıkar.",
      questionsCount: 0.5,
    },
    {
      title: "Yazım Kuralları",
      description: "Büyük harflerin kullanımı, sayıların yazımı, birleşik sözcüklerin yazımı ve kısaltmalar.",
      questionsCount: 1.0,
    },
    {
      title: "Noktalama İşaretleri",
      description: "Nokta, virgül, noktalı virgül ve diğer işaretlerin doğru kullanım alanları.",
      questionsCount: 1.0,
    },
    {
      title: "Anlatım Bozuklukları",
      description: "Anlamsal ve yapısal anlatım bozuklukları, gereksiz sözcük kullanımı ve mantık hataları.",
      questionsCount: 0.5,
    },
    {
      title: "Sözel Mantık",
      description: "Verilen bilgiler ışığında akıl yürütme, tablolama ve çıkarım yapma soruları.",
      questionsCount: 3.0,
    },
  ],
  matematik: [
    {
      ...
      description: "Rakamlar, sayılar, tam sayılar, doğal sayılar ve temel aritmetik işlemler.",
      questionsCount: 1.0,
    },
    {
      title: "Tek / Çift Sayılar",
      description: "Sayıların teklik ve çiftlik özellikleri ve bu sayılarla yapılan işlemlerin kuralları.",
      questionsCount: 1.0,
    },
    {
      title: "Ardışık Sayılar",
      description: "Belli bir kurala göre ardı ardına gelen sayı dizileri ve bunların toplam formülleri.",
      questionsCount: 1.0,
    },
    {
    ...
    },
    {
      ...
      description: "2, 3, 4, 5, 8, 9, 10 ve 11 ile bölünebilme kuralları ve kalan bulma.",
      questionsCount: 0.5,
    },
    {
      title: "EBOB - EKOK",
      description: "En büyük ortak bölen, en küçük ortak kat bulma formülleri ve EBOB-EKOK problemleri.",
      questionsCount: 0.5,
    },
    {
      title: "Faktöriyel / Asal Sayılar",
      description: "Faktöriyel kavramı, asal sayılar ve aralarında asal sayılar özellikleri.",
      questionsCount: 0.5,
    },
    {
      title: "Basit Eşitsizlikler",
      description: "Büyüklük-küçüklük bağıntıları ve eşitsizliklerin çözüm kümeleri.",
      questionsCount: 0.5,
    },
    {
      title: "Mutlak Değer",
      description: "Bir sayının başlangıç noktasına uzaklığı ve mutlak değerli denklem/eşitsizlikler.",
      questionsCount: 1.0,
    },
    {
      title: "Rasyonel Sayılar",
      description: "Kesirler, ondalık gösterimler ve rasyonel sayılarda dört işlem.",
      questionsCount: 1.0,
    },
    {
      title: "Üslü / Köklü Sayılar",
      description: "Üslü ifadeler, köklü ifadeler ve bu ifadelerle yapılan temel matematiksel işlemler.",
      questionsCount: 2.0,
    },
    {
      title: "Çarpanlara Ayırma",
      description: "Özdeşlikler, ortak çarpan parantezine alma ve sadeleştirme yöntemleri.",
      questionsCount: 0.5,
    },
    {
    ...
    {
      title: "Oran Orantı",
      description: "Doğru orantı, ters orantı, bileşik orantı ve ortalama kavramları.",
      questionsCount: 0.5,
    },
    {
      title: "Sayı / Kesir Problemleri",
      description: "Muhakeme yeteneğini ölçen sayısal ve kesirli problem türleri.",
      questionsCount: 4.0,
    },
    {
      title: "Yaş / Hareket Problemleri",
      description: "Yaş hesaplama ve hız-zaman-yol ilişkisi üzerine kurulu problemler.",
      questionsCount: 2.0,
    },
    {
      title: "Yüzde / Kar / Zarar / Karışım",
      description: "Yüzde hesaplamaları, ticari kar-zarar ve madde karışım problemleri.",
      questionsCount: 2.0,
    },
    {
      title: "Grafik ve Tablo Problemleri",
      description: "Daire, sütun ve çizgi grafikleri ile tabloları okuma, analiz etme ve yorumlama.",
      questionsCount: 2.0,
    },
    {
      title: "İstatistik",
      description: "Mod, medyan, açıklık ve standart sapma gibi temel istatistiksel veriler.",
      questionsCount: 0.5,
    },
    {
      title: "Kümeler",
    ...
    },
    {
      ...
      description: "Şekil yeteneği, sayı dizileri ve mantıksal çıkarım soruları.",
      questionsCount: 2.0,
    },
  ],
  geometri: [
    ...
    },
    {
      ...
      description: "Paralel doğrular arası açılar ve üçgenin iç/dış açılarının özellikleri.",
      questionsCount: 0.3,
    },
    {
      title: "Özel Üçgenler",
      description: "Dik üçgen, ikizkenar üçgen ve eşkenar üçgenin kendine has özellikleri ve Pisagor teoremi.",
      questionsCount: 0.5,
    },
    {
    ...
    },
    {
      ...
      description: "Üçgenin alan formülleri ve üçgenler arasındaki benzerlik oranları.",
      questionsCount: 0.4,
    },
    {
      title: "Çokgenler ve Dörtgenler",
      description: "Kare, dikdörtgen, paralelkenar ve yamuk gibi geometrik şekillerin özellikleri.",
      questionsCount: 0.5,
    },
    {
      title: "Çember ve Daire",
      description: "Çemberde açılar, uzunluk ve dairenin alan/çevre hesaplamaları.",
      questionsCount: 0.4,
    },
    {
      title: "Analitik Geometri",
      description: "Koordinat sistemi, doğru denklemleri ve nokta-doğru ilişkileri.",
      questionsCount: 0.3,
    },
    {
      title: "Katı Cisimler",
      description: "Prizmalar, silindir, piramit ve küre gibi üç boyutlu şekillerin hacim ve alanları.",
      questionsCount: 0.2,
    },
  ],
  tarih: [
    {
      ...
      description: "Orta Asya Türk devletleri (Hunlar, Göktürkler, Uygurlar) ve göç hareketleri.",
      questionsCount: 1.0,
    },
    {
      title: "İlk Türk İslam Devletleri",
      description: "Karahanlılar, Gazneliler ve Selçuklular dönemi siyasi ve kültürel gelişmeler.",
      questionsCount: 2.0,
    },
    {
      title: "Anadolu Selçuklu ve Beylikler",
      description: "Anadolu'nun türkleşmesi, Selçuklu devleti ve II. Beylikler dönemi.",
      questionsCount: 1.0,
    },
    {
      title: "Osmanlı Kültür ve Medeniyeti",
      description: "Devlet yönetimi, ordu, eğitim ve toplumsal yapı gibi Osmanlı kurumları.",
      questionsCount: 3.0,
    },
    {
      title: "Osmanlı Siyaseti (Kuruluş-Dağılma)",
      description: "Padişahlar dönemi fetihler, antlaşmalar ve devletin siyasi gelişimi.",
      questionsCount: 3.0,
    },
    {
      title: "20. Yüzyılda Osmanlı",
      description: "Trablusgarp Savaşı, Balkan Savaşları ve I. Dünya Savaşı süreci.",
      questionsCount: 2.0,
    },
    {
      title: "Kurtuluş Savaşı Hazırlık",
      description: "Genelgeler, kongreler ve Milli Mücadele'nin teşkilatlanma aşaması.",
      questionsCount: 3.0,
    },
    {
      title: "I. TBMM ve Ayaklanmalar",
      description: "Meclisin açılışı, kabul edilen kanunlar ve iç isyanlara karşı önlemler.",
      questionsCount: 1.0,
    },
    {
      title: "Kurtuluş Savaşı Cepheler",
      description: "Doğu, Güney ve Batı cepheleri; düzenli ordunun savaşları (Sakarya, Büyük Taarruz).",
      questionsCount: 3.0,
    },
    {
      title: "Cumhuriyet ve İnkılaplar",
      description: "Siyasi, sosyal ve hukuk alanında yapılan modernleşme adımları.",
      questionsCount: 4.0,
    },
    {
    ...
    },
    {
      ...
      description: "İç politika gelişmeleri ve yurtta sulh cihanda sulh temelli dış politika.",
      questionsCount: 1.0,
    },
    {
      title: "Çağdaş Türk ve Dünya Tarihi",
      description: "II. Dünya Savaşı sonrası Türkiye ve dünyadaki önemli gelişmeler.",
      questionsCount: 2.0,
    },
  ],
  cografya: [
    ...
    },
    {
      ...
      description: "Nüfus sayımları, göçler, yerleşme tipleri ve nüfusun dağılışı.",
      questionsCount: 3.0,
    },
    {
      title: "Doğal Afetler",
      description: "Deprem, heyelan, erozyon ve sel gibi olayların nedenleri ve sonuçları.",
      questionsCount: 0.5,
    },
    {
      title: "Tarım / Hayvancılık",
      description: "Yetiştirilen tarım ürünleri ve bölgelere göre hayvancılık faaliyetleri.",
      questionsCount: 2.5,
    },
    {
      title: "Madenler / Enerji Kaynakları",
      description: "Yeraltı zenginlikleri, yenilenebilir ve yenilenemez enerji kaynakları.",
      questionsCount: 2.0,
    },
    {
    ...
    },
    {
      ...
      description: "Türkiye'nin iç ve dış ticareti, ulaşım ağları ve önemli turizm merkezleri.",
      questionsCount: 1.0,
    },
    {
      title: "Bölgesel Kalkınma Projeleri",
      description: "GAP, DAP, KOP, DOKAP, ZBK gibi bölgesel kalkınma projelerinin kapsamı ve amaçları.",
      questionsCount: 0.5,
    },
  ],
  vatandaslik: [
    ...
    },
    {
      ...
      description: "TBMM, Cumhurbaşkanlığı ve mahkemelerin görev, yetki ve işleyişleri.",
      questionsCount: 3.0,
    },
    {
      title: "İdare Hukuku",
      description: "Merkezden ve yerinden yönetim kuruluşları ve kamu görevlileri.",
      questionsCount: 2.0,
    },
    {
    ...
    },
    {
      ...
      description: "BM, NATO, AB ve Türkiye'nin üye olduğu diğer uluslararası kuruluşlar.",
      questionsCount: 1.0,
    },
    {
    ...
    },
    {
      ...
      description: "Yılın önemli haberleri, kültürel başarılar ve güncel tartışmalar.",
      questionsCount: 2.0,
    },
  ],
};
