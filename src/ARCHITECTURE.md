...
| NotesView             | zettelkastenEngine, useNotes (hook)                                        | sync       | notes/ (16 — NoteCard=tuval+NoteCardInlineEditor, NotesDayScorePanel (güne puan/mood tracker, dayScores), NoteEditorModal=tuval+Header/Body/WikiAutocomplete/BacklinksPanel, ZettelkastenGraphModal=tuval+GraphLegend/GraphSvgCanvas)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
