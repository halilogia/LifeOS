...
| `src/components/aichat/`                       | Newtab AI Asistan alt bileşenleri  | AiChatHeaderBar, AiChatMessageItem, AiChatInputToolbar, AiChatHistoryDrawer, ClarificationCard, QueuedMessagesBar                                                                                                    | State                                 |
...
| `src/services/aichat/`                         | AI Chat Servisleri                 | chatSessionService, fileAttachmentService, providers, systemPrompt, actionExecutor, memoryRepository                                                                                              | JSX                                   |
