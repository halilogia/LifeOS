...
| `src/components/aichat/`                       | Newtab AI Asistan alt bileşenleri  | AiChatHeaderBar, AiChatMessageItem, AiChatInputToolbar, AiChatHistoryDrawer, ClarificationCard                                                                                                                       | State                                 |
...
| `src/sidepanel/`                               | Side Panel Web Copilot             | SidePanelApp, SidePanelHeader, SidePanelHistoryDrawer, SidePanelTabBar, SidePanelChips, SidePanelMessages, SidePanelInputBar, CommandSuggestionMenu, useSidePanelChat, useChatSession, useAgentBridge | —                                     |
