...
| Stock/BistView        | bistService, stockAiService, useBist (hook)                     | sync      | stock/ (26 — BistSearchBar=tuval+SearchResultCard/NoResultCard/searchIcons, PortfolioTable=tuval+PortfolioRow/portfolioIcons, CustomStockChart=tuval+stockChartDrawer/ChartHoverBar/ChartRangeSelector) + stock/kesfet/ (4 — BistKesfetTab parçaları) + services/stock/ (3) |
