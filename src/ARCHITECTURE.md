...
| NotesView             | zettelkastenEngine, useNotes (hook)                             | sync       | notes/ (15 — NoteCard=tuval+NoteCardInlineEditor, NoteEditorModal=tuval+Header/Body/WikiAutocomplete/BacklinksPanel, ZettelkastenGraphModal=tuval+GraphLegend/GraphSvgCanvas) |
