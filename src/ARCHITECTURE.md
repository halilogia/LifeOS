...
flowchart TB
    ...
    subgraph Domain["domain/ (Saf mantık — UI/storage bağımsız)"]
        ...
        repositories["repositories/ (Interfaces — ITodoRepository, IUserSyncProfileRepository)"]
...
| `src/infrastructure/persistence/repositories/` | chrome.storage implementasyonları | ChromeStorage*Repository (incl. ChromeStorageUserSyncProfileRepository — sync profile: prayerCity, willpowerStreak, detox config)       | UI                                    |
...
| PrayerView            | prayerService, usePrayer (hook)                                            | sync+local | prayer/ (1) — PrayerCityForm                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| WillpowerView         | useWillpower (hook)                                                        | sync+local | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
