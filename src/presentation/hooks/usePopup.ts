...
export function usePopup() {
    ...
    const handlePomoTabChange = useCallback(async (mode: "focus" | "short" | "long") => {
    ...
    const handleToggleAlarm = useCallback(async (id: string, enabled: boolean) => {
    ...
    const handleTogglePopupSite = useCallback((siteDomains: string[]) => {
