/**
 * BlockerUI.ts
 * DOM Overlay injection, countdown timer rendering, and warning banner display for detox blocker.
 * Security: Safe DOM building & HTML escaping (AGENTS.md 4.4).
 */

import { getTranslation } from "@/utils/i18n.js";
import type { Language } from "@/types/types.js";

export function showTopWarningBanner(
  minutesLeft: number,
  lang: string,
  domain: string,
): void {
...
export interface SetupBlockPageOptions {
  endTime: number;
...
export function setupBlockPage(options: SetupBlockPageOptions): void {
  const {
    endTime,
    customQuotes,
    lang,
