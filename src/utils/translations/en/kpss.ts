export const kpss = {
  ...
  kpss_tab_map: "Maps",
  kpss_map_title: "Turkey Geography Map",
  kpss_map_cat_fiziki: "Physical Geography",
  kpss_map_cat_beseri: "Human Geography",
  kpss_map_cat_ekonomik: "Economic Geography",
  ...
  kpss_map_title_coasts: "Turkey Coast Types, Straits & Bays",
  kpss_map_title_karst: "Karst Formations, Sinkholes & Caves",
  kpss_map_title_climate_rain: "Rainfall Distribution, Climate & Winds",
  kpss_map_title_population: "Population Density (Sparse / Dense Regions)",
  kpss_map_title_dwellings: "Rural Dwelling Types & Building Materials",
  kpss_map_title_development_projects: "Regional Development Projects (RDP)",
  kpss_map_title_agriculture: "Agricultural Crop Production Areas",
  kpss_map_title_livestock: "Livestock Types & Breeding Basins",
  ...
  // Topics
  kpss_map_topic_mountains: "Mountains (All Types)",
  ...
  kpss_map_topic_coasts: "Coast Types & Bays",
  kpss_map_topic_karst: "Karst & Caves",
  kpss_map_topic_passes: "Passes",
  kpss_map_topic_gates: "Border Gates",
  kpss_map_topic_unesco: "UNESCO Sites & Tourism",
  kpss_map_topic_gulfs: "Gulfs",
  kpss_map_topic_climate_rain: "Rainfall & Winds",
  kpss_map_topic_population: "Population Density",
  kpss_map_topic_dwellings: "Dwelling Types",
  kpss_map_topic_development_projects: "Regional Dev Projects",
  kpss_map_topic_agriculture: "Agriculture Crops",
  kpss_map_topic_livestock: "Livestock Regions",
  kpss_map_topic_mines: "Mines & Facilities",
  kpss_map_topic_energy: "Power Plants",
  kpss_map_topic_industry: "Industrial Zones",
  kpss_map_topic_transport_borders: "Transport & Border Gates",
  ...
  kpss_map_legend_coasts: "Coast type / Bay",
  kpss_map_legend_karst: "Karst landform / Cave",
  kpss_map_legend_passes: "Pass",
  kpss_map_legend_gates: "Border Gate",
  kpss_map_legend_unesco: "UNESCO World Heritage / Tourism Site",
  kpss_map_legend_gulfs: "Gulf",
  kpss_map_legend_climate_rain: "Climate / Rain point",
  kpss_map_legend_population: "Population zone",
  kpss_map_legend_dwellings: "Dwelling material zone",
  kpss_map_legend_development_projects: "RDP Project Center",
  kpss_map_legend_agriculture: "Agricultural basin",
  kpss_map_legend_livestock: "Livestock basin",
  kpss_map_legend_mines: "Mine / Plant",
  kpss_map_legend_energy: "Power Plant",
  kpss_map_legend_industry: "Industrial Facility",
  kpss_map_legend_transport_borders: "Transport / Border Gate",
