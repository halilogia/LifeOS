...
export function EisenhowerView({
  ...
  return (
    <div className="view-content active" id="eisenhower-view" style={{ display: "flex", flexDirection: "column", gap: "16px", height: "calc(100vh - 120px)" }}>
      ...
      <div className="pomodoro-tab-header" style={{ marginBottom: "8px", display: "flex", justifyContent: "flex-start", gap: "10px" }}>
        <button
