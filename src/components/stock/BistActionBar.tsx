/**
 * BistActionBar.tsx
 * BIST Dashboard sekmeleri ve aksiyon butonları (BIST Portföy, Halka Arz Takvimi, KAP Haberleri, + Hisse Ekle, Alarmlar, Yenile).
 */

export type BistTabId = "portfolio" | "halka-arz" | "ai-report" | "chart";
