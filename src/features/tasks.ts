...
export function moveTaskWithStatus(index: number, newStatus: Todo["status"], todos: Todo[]): void {
...
export function getUpdatedStatuses(todos: Todo[], index: number, direction: number): Todo["status"] | null {
