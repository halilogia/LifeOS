...
> **Version**: `1.0.0`  
> **Generated Date**: `2026-08-13 04:01`
...
### 📊 Codebase Statistics
- **Total Source Files**: `592`
- **Total Lines of Code (LOC)**: `133,930 lines`
- **UI Components**: `215 files`
- **Custom Hooks**: `24 files`
- **Services / API Handlers**: `68 files`
...
| `src/components/` | Components components and modules | 31 files |
...
| `src/services/` | Services components and modules | 13 files |
